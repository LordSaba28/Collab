        ...
        <section class="recipe-without-sidebar-wrap padding-top-80 padding-bottom-22">
            <div class="container">
                ...
                <div class="row">
                    ...
                    <div class="col-lg-4 col-md-6 col-sm-6 col-12">
                        <div class="product-box-layout1">
                            <figure class="item-figure"><a href="single-recipe1.php"><img src="img/product/product39.jpg"
                                        alt="Product"></a></figure>
                            <div class="item-content">
                                <span class="sub-title">CHICKEN</span>
                                <h3 class="item-title"><a href="single-recipe1.php">Tomatoes Stuffed with Foie
                    ...
                    <div class="col-lg-4 col-md-6 col-sm-6 col-12">
                        <div class="product-box-layout1">
                            <figure class="item-figure"><a href="single-recipe1.php"><img src="img/product/product40.jpg"
                                        alt="Product"></a></figure>
                            <div class="item-content">
                                <span class="sub-title">CHICKEN</span>
                                <h3 class="item-title"><a href="single-recipe1.php">Tomatoes Stuffed with Foie
                    ...
                    <div class="col-lg-4 col-md-6 col-sm-6 col-12">
                        <div class="product-box-layout1">
                            <figure class="item-figure"><a href="single-recipe1.php"><img src="img/product/product41.jpg"
                                        alt="Product"></a></figure>
                            <div class="item-content">
                                <span class="sub-title">CHICKEN</span>
                                <h3 class="item-title"><a href="single-recipe1.php">Tomatoes Stuffed with Foie
                    ...
                    <div class="col-lg-4 col-md-6 col-sm-6 col-12">
                        <div class="product-box-layout1">
                            <figure class="item-figure"><a href="single-recipe1.php"><img src="img/product/product42.jpg"
                                        alt="Product"></a></figure>
                            <div class="item-content">
                                <span class="sub-title">CHICKEN</span>
                                <h3 class="item-title"><a href="single-recipe1.php">Tomatoes Stuffed with Foie
                    ...
                    <div class="col-lg-4 col-md-6 col-sm-6 col-12">
                        <div class="product-box-layout1">
                            <figure class="item-figure"><a href="single-recipe1.php"><img src="img/product/product43.jpg"
                                        alt="Product"></a></figure>
                            <div class="item-content">
                                <span class="sub-title">CHICKEN</span>
                                <h3 class="item-title"><a href="single-recipe1.php">Tomatoes Stuffed with Foie
                    ...
                    <div class="col-lg-4 col-md-6 col-sm-6 col-12">
                        <div class="product-box-layout1">
                            <figure class="item-figure"><a href="single-recipe1.php"><img src="img/product/product44.jpg"
                                        alt="Product"></a></figure>
                            <div class="item-content">
                                <span class="sub-title">CHICKEN</span>
                                <h3 class="item-title"><a href="single-recipe1.php">Tomatoes Stuffed with Foie
                    ...
                    <div class="col-lg-4 col-md-6 col-sm-6 col-12">
                        <div class="product-box-layout1">
                            <figure class="item-figure"><a href="single-recipe1.php"><img src="img/product/product45.jpg"
                                        alt="Product"></a></figure>
                            <div class="item-content">
                                <span class="sub-title">CHICKEN</span>
                                <h3 class="item-title"><a href="single-recipe1.php">Tomatoes Stuffed with Foie
                    ...
                    <div class="col-lg-4 col-md-6 col-sm-6 col-12">
                        <div class="product-box-layout1">
                            <figure class="item-figure"><a href="single-recipe1.php"><img src="img/product/product46.jpg"
                                        alt="Product"></a></figure>
                            <div class="item-content">
                                <span class="sub-title">CHICKEN</span>
                                <h3 class="item-title"><a href="single-recipe1.php">Tomatoes Stuffed with Foie
                    ...
                    <div class="col-lg-4 col-md-6 col-sm-6 col-12">
                        <div class="product-box-layout1">
                            <figure class="item-figure"><a href="single-recipe1.php"><img src="img/product/product47.jpg"
                                        alt="Product"></a></figure>
                            <div class="item-content">
                                <span class="sub-title">CHICKEN</span>
                                <h3 class="item-title"><a href="single-recipe1.php">Tomatoes Stuffed with Foie
                    ...
                    <div class="col-lg-4 col-md-6 col-sm-6 col-12">
                        <div class="product-box-layout1">
                            <figure class="item-figure"><a href="single-recipe1.php"><img src="img/product/product48.jpg"
                                        alt="Product"></a></figure>
                            <div class="item-content">
                                <span class="sub-title">CHICKEN</span>
                                <h3 class="item-title"><a href="single-recipe1.php">Tomatoes Stuffed with Foie
                    ...
                    <div class="col-lg-4 col-md-6 col-sm-6 col-12">
                        <div class="product-box-layout1">
                            <figure class="item-figure"><a href="single-recipe1.php"><img src="img/product/product49.jpg"
                                        alt="Product"></a></figure>
                            <div class="item-content">
                                <span class="sub-title">CHICKEN</span>
                                <h3 class="item-title"><a href="single-recipe1.php">Tomatoes Stuffed with Foie
