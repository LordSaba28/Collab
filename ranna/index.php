            ...
            <div class="container">
                <div class="rc-carousel nav-control-layout2" data-loop="true" data-items="30" data-margin="5"
                    ...
                    <div class="ranna-slider-content-layout1">
                        <figure class="item-figure"><a href="single-recipe1.php"><img src="img/slider/slide1-1.jpg" alt="Product"></a></figure>
                    ...
                    <div class="ranna-slider-content-layout1">
                        <figure class="item-figure"><a href="single-recipe1.php"><img src="img/slider/slide1-2.jpg" alt="Product"></a></figure>
                        <div class="item-content">
                            <span class="sub-title">SALAD</span>
                            <h2 class="item-title"><a href="single-recipe1.php">Italiano Salad Mixed</a></h2>
                            <ul class="item-rating">
                    ...
                    <div class="ranna-slider-content-layout1">
                        <figure class="item-figure"><a href="single-recipe1.php"><img src="img/slider/slide1-3.jpg" alt="Product"></a></figure>
                        <div class="item-content">
                            <span class="sub-title">SALAD</span>
                            <h2 class="item-title"><a href="single-recipe1.php">Italiano Salad Mixed</a></h2>
                            <ul class="item-rating">
                ...
                <div class="row">
                    <div class="col-lg-4 col-md-6 col-sm-12">
                        <div class="product-box-layout1">
                            <figure class="item-figure"><a href="single-recipe1.php"><img src="img/product/product1.jpg"
                    ...
                    <div class="col-lg-4 col-md-6 col-sm-12">
                        <div class="product-box-layout1">
                            <figure class="item-figure"><a href="single-recipe1.php"><img src="img/product/product2.jpg"
                                        alt="Product"></a></figure>
                            <div class="item-content">
                    ...
                    <div class="col-lg-4 d-block d-md-none d-lg-block col-sm-12">
                        <div class="product-box-layout1">
                            <figure class="item-figure"><a href="single-recipe1.php"><img src="img/product/product3.jpg"
                                        alt="Product"></a></figure>
                            <div class="item-content">
                ...
                <div class="row gutters-60">
                    <div class="col-lg-8">
                        ...
                        <div class="row">
                            <div class="col-12">
                                <div class="product-box-layout1">
                                    <figure class="item-figure"><a href="single-recipe1.php"><img src="img/product/product4.jpg"
                                                alt="Product"></a></figure>
                                    <div class="item-content">
                            ...
                            <div class="col-md-6 col-sm-6 col-12">
                                <div class="product-box-layout1">
                                    <figure class="item-figure"><a href="single-recipe1.php"><img src="img/product/product5.jpg"
                                                alt="Product"></a></figure>
                                    <div class="item-content">
                            ...
                            <div class="col-md-6 col-sm-6 col-12">
                                <div class="product-box-layout1">
                                    <figure class="item-figure"><a href="single-recipe1.php"><img src="img/product/product6.jpg"
                                                alt="Product"></a></figure>
                                    <div class="item-content">
                                        <span class="sub-title">SALAD</span>
                            ...
                            <div class="col-md-6 col-sm-6 col-12">
                                <div class="product-box-layout1">
                                    <figure class="item-figure"><a href="single-recipe1.php"><img src="img/product/product7.jpg"
                                                alt="Product"></a></figure>
                                    <div class="item-content">
                            ...
                            <div class="col-md-6 col-sm-6 col-12">
                                <div class="product-box-layout1">
                                    <figure class="item-figure"><a href="single-recipe1.php"><img src="img/product/product8.jpg"
                                                alt="Product"></a></figure>
                                    <div class="item-content">
                                        <span class="sub-title">JUICE</span>
                                        <h3 class="item-title"><a href="single-recipe1.php">Soypan Fruits Juice</a></h3>
                                        <ul class="item-rating">
                                            <li class="star-fill"><i class="fas fa-star"></i></li>
                                            <li class="star-fill"><i class="fas fa-star"></i></li>
                                            <li class="star-fill"><i class="fas fa-star"></i></li>
                            ...
                            <div class="col-md-6 col-sm-6 col-12">
                                <div class="product-box-layout1">
                                    <figure class="item-figure"><a href="single-recipe1.php"><img src="img/product/product9.jpg"
                                                alt="Product"></a></figure>
                                    <div class="item-content">
                                        <span class="sub-title">BREAKFAST</span>
                                        <h3 class="item-title"><a href="single-recipe1.php">Crepes with Forest</a></h3>
                                        <ul class="item-rating">
                                            <li class="star-fill"><i class="fas fa-star"></i></li>
                                            <li class="star-fill"><i class="fas fa-star"></i></li>
                                            <li class="star-fill"><i class="fas fa-star"></i></li>
                            ...
                            <div class="col-md-6 col-sm-6 col-12">
                                <div class="product-box-layout1">
                                    <figure class="item-figure"><a href="single-recipe1.php"><img src="img/product/product10.jpg"
                                                alt="Product"></a></figure>
                                    <div class="item-content">
                                        <span class="sub-title">DINNER</span>
                                        <h3 class="item-title"><a href="single-recipe1.php">Asian Chicken Noodles</a></h3>
                ...
                <div class="row">
                    <div class="col-lg-4 col-md-6 col-sm-12 col-12">
                        <div class="product-box-layout2">
                            <figure class="item-figure"><a href="single-recipe1.php"><img src="img/product/product11.jpg"
                                        alt="Product"></a></figure>
                            <div class="item-content">
                                <span class="sub-title">BREAKFAST</span>
                                <h3 class="item-title"><a href="single-recipe1.php">Tomatoes Stuffed with Foie and
                    ...
                    <div class="col-lg-4 col-md-6 col-sm-12 col-12">
                        <div class="product-box-layout2">
                            <figure class="item-figure"><a href="single-recipe1.php"><img src="img/product/product12.jpg"
                                        alt="Product"></a></figure>
                            <div class="item-content">
                                <span class="sub-title">DESERT</span>
                                <h3 class="item-title"><a href="single-recipe1.php">Pumpkin Cheesecake With
                    ...
                    <div class="col-lg-4 d-block d-md-none d-lg-block col-sm-12 col-12">
                        <div class="product-box-layout2">
                            <figure class="item-figure"><a href="single-recipe1.php"><img src="img/product/product13.jpg"
                                        alt="Product"></a></figure>
                            <div class="item-content">
                                <span class="sub-title">JUICE</span>
                                <h3 class="item-title"><a href="single-recipe1.php">Blueberry Juice with Lemon Crema</a></h3>
                        ...
                        <div class="row">
                            <div class="col-xl-12 col-lg-6 col-md-6 col-sm-6 col-12">
                                <div class="product-box-layout3">
                                    <figure class="item-figure"><a href="single-recipe1.php"><img src="img/product/product14.jpg"
                                                alt="Product"></a></figure>
                                    <div class="item-content">
                                        <span class="sub-title">BREAKFAST</span>
                                        <h3 class="item-title"><a href="single-recipe1.php">Asian Chicken Noodles</a></h3>
                            ...
                            <div class="col-xl-12 col-lg-6 col-md-6 col-sm-6 col-12">
                                <div class="product-box-layout3">
                                    <figure class="item-figure"><a href="single-recipe1.php"><img src="img/product/product15.jpg"
                                                alt="Product"></a></figure>
                                    <div class="item-content">
                            ...
                            <div class="col-xl-12 col-lg-6 col-md-6 col-sm-6 col-12">
                                <div class="product-box-layout3">
                                    <figure class="item-figure"><a href="single-recipe1.php"><img src="img/product/product16.jpg"
                                                alt="Product"></a></figure>
                                    <div class="item-content">
                                        <span class="sub-title">SALAD</span>
                                        <h3 class="item-title"><a href="single-recipe1.php">Maxican Dessert</a></h3>
